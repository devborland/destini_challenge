...
//TODO: Step 4 - Create a Constructor for this class 
// to be able  to initialise the properties created in step 3.
...
class Story{
  ...
  void Story = Story({this.storyTitle, this.choice1, this.choice2});
}